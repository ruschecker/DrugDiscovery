...
$job="<job_desc>
    <task>
        ...
        <command_line>--ligand ligand.pdbqt --receptor receptor.pdbqt --cpu 1 --center_x ".$center_x." --center_y ".$center_y." --center_z ".$center_z." --size_x ".$size_x." --size_y ".$size_y. " --size_z ".$size_z." --seed ".$seed." --exhaustiveness 100</command_line>
        <weight>1</weight>
    </task>
</job_desc>";
